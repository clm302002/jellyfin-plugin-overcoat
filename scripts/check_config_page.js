...
const cssPatterns = [
  ...
  ['desktop shell has a navigation rail', /grid-template-columns:\s*var\(--ov-rail\)\s+minmax\(0,\s*1fr\)/],
  ['mobile shell has bottom navigation', /@media\s*\(max-width:\s*700px\)[\s\S]*\.ovcTabs\s*\{[\s\S]*position:\s*fixed/],
