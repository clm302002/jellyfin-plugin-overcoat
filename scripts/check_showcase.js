...
const expected = {
  ...
  'settings-posters.png':[1440,1000], 'settings-wide.png':[1440,1000],
  'settings-libraries.png':[1440,1000], 'settings-sources.png':[1440,1000],
  'settings-automation.png':[1440,1000], 'settings-recovery.png':[1440,1000],
};
let failed = false;
